...
namespace Jv.Games.Xna.Async
{
    ...
    public static class ContextTimerExtensions
    {
        ...
        public static ContextOperation<TimeSpan> Delay(this AsyncContext context, TimeSpan dueTime, CancellationToken cancellationToken = default(CancellationToken))
        {
